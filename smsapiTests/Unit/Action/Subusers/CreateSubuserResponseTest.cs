...
[TestClass]
public class CreateSubuserResponseTest
{
    ...
    [DataRow(true)]
    [DataRow(false)]
    public void create_subuser(bool active)
    {
    ...
    private SubuserDetails CreateSubuser()
    {
        var action = new CreateSubuser(SubuserCredentialsMother.Any());
